// https://github.com/solana-labs/solana-program-library/blob/master/token-lending/program/src/math/rate.rs
...
impl Rate {
    ...
    pub fn from_percent_3dp(percent: u32) -> Self {
        Self(U128::from(percent as u64 * PERCENT_SCALER_3DP))
    }
