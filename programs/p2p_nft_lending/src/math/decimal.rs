...
impl Decimal {
    ...
    pub fn from_percent_3dp(percent: u32) -> Self {
        Self(U192::from(percent as u64 * PERCENT_SCALER_3DP))
    }
    ...
    // Helpers
   pub fn pack(decimal: Decimal, dst: &mut [u8; 16]) {
        *dst = decimal
            .to_scaled_val()
...
mod test {
    ...
    fn test_scaler() {
        ...
        println!("{}", Decimal::from_percent_3dp(30));
    }
}
